...
const Footer = () => {
  return (
    ...
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-1 sm:p-3 fixed bottom-0 gap-y-2">
  ...
  <nav className=" w-full sm:w-auto grid grid-flow-col gap-4 justify-center md:place-self-center md:justify-self-end mb-1 ">
